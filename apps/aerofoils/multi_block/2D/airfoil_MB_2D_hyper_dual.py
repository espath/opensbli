...
# Map hyper-dual lagrangian velocity symbol to the standard airfoil velocity symbol.
vl_to_u = Einstein_expansion.expand("Eq(vl_i, u_i)", ndim, coordinate_symbol, [], constants)
for eq in vl_to_u:
    Einstein_expansion.optional_subs_dict[eq.lhs] = eq.rhs

# Hyper dual-velocity equations using Ma-based dimensionless scaling.
...
mass, momentum, energy = HDV.mass, HDV.momentum, HDV.energy
