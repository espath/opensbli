...
if [[ ! -f "${GRID_DIR}/data_upper_half.h5" ]]; then
  echo "Missing half mesh: ${GRID_DIR}/data_upper_half.h5"
  exit 1
fi

ln -sf "${GRID_DIR}/data_upper_half.h5" data.h5
...
"${PYTHON_BIN}" half_annulus_hyper_dual.py
